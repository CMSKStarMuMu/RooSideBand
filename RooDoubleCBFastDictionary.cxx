...
#define R__DICTIONARY_FILENAME RooDoubleCBFastDictionary
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RooDoubleCBFast*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace {
  void TriggerDictionaryInitialization_RooDoubleCBFastDictionary_Impl() {
...
#line 1 "RooDoubleCBFastDictionary dictionary forward declarations' payload"
...
#line 1 "RooDoubleCBFastDictionary dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("RooDoubleCBFastDictionary",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_RooDoubleCBFastDictionary_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_RooDoubleCBFastDictionary_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_RooDoubleCBFastDictionary() {
  TriggerDictionaryInitialization_RooDoubleCBFastDictionary_Impl();
}
